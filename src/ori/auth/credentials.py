...
from ori.auth.oauth_flow import run_consent_flow
from ori.auth.token_store import EncryptedTokenStore
from ori.common.config import Config, ensure_dirs, load_config
from ori.common.logging import get_logger, log_operation
from ori.common.retry import retry_with_backoff
...
def get_credentials(
    ...
    *,
    ...
    ensure_dirs(config)
    logger = get_logger("ori.auth", log_dir=config.log_dir)
